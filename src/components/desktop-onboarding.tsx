...
export function DesktopOnboarding({ step, playerName, onNext }: DesktopOnboardingProps) {
  const slides: OnboardingSlide[] = [
    ...
    {
      mascot: '/assets/Shared/Mascots/Mascot_Neutral.png',
      content: <>Sebelum mulai, kita bikin profilmu dulu, buka <strong className={pink}>Browser</strong>. Aku tungguin untuk kamu!</>,
    },
    {
    ...
    {
      mascot: '/assets/Shared/Mascots/Mascot_Happy.png',
      content: <>Sekarang, kamu bebas mencoba permainan dalam JEJAK, <strong className={cyan}>selamat bermain dan belajar!</strong></>,
    },
  ];
